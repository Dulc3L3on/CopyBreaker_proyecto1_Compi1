...
public class Lexer implements java_cup.runtime.Scanner {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    ...
    "\1\47\1\50\1\51\3\17\1\13\1\5\1\13\123\0"+
    "\1\17\37\0\1\17\u010e\0";
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 56: break;
          case 13:
            { if(operadorAnterior != null){return sendSingleOperator();}else{System.out.println("[L] comentario-línea: "+ yytext().substring(2).trim());
                                       result.addComentario(new Comentario(yytext().substring(2).trim()));}
            }
            // fall through
          case 57: break;
          case 14:
          ...
          case 66: break;
          case 23:
            { if(operadorAnterior != null){return sendSingleOperator();}else{System.out.println("[L] comentario-multiLinea: "+ yytext().substring(2, yytext().length()-2).trim());
