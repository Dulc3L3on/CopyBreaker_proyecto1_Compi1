...
public class Error {
    ...
    private final String sintaxErrors[] = new String[]{
        ...
        "Variable [String] mal formada", 
        "Variable [char] mal formada",
        "Variable [boolean] mal formada", 
        "Variable [Object] mal formada",
        "Variable personalizada [Objeto] mal formada",
        "Definición de método|constructor con errores",
        "Definición de constructor|metodo<tipo>|metodo void con errores",
        "Cuerpo de constructor con errores",
        "Cuerpo de método [int|double] con errores",         
        "Cuerpo de método [String] con errores", 
        "Cuerpo de método [char] con errores",
        "Cuerpo de método [boolean] con errores", 
        "Cuerpo de método [Object] con errores",
